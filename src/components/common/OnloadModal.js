      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="deal" style={{ backgroundImage: "url('/assets/imgs/theme/fruits-modal.png')" }}>
              <div className="deal-top">
                <h6 className="mb-10 text-brand-2">Fresh & Healthy</h6>
              </div>
              <div className="deal-content detail-info">
                <h4 className="product-title">
                  <Link to="/shop-product-right" className="text-heading">Tropical Fruit Collection</Link>
                </h4>
              ...
              <div className="deal-bottom">
                ...
                <div className="deals-countdown pl-5" data-countdown="2025/12/25 00:00:00">
                ...
                <Link to="/shop" className="btn hover-up">Shop Now <i className="fi-rs-arrow-right"></i></Link>
              </div>
            </div>
          </div>
        </div>
