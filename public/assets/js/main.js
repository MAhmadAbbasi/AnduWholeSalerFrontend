(function ($) {
    ...
    /*------ Hero slider 1 ----*/
        // Wrap $.fn.slick to avoid throwing when React controls carousels or elements are missing
        (function(){
            if ($.fn && $.fn.slick) {
                ...
                $.fn.slick = function() {
                    try {
                        ...
                        console.warn('Slick init skipped due to error:', e);
                        return this;
                    }
                };
            }
    ...
    /*---------------------
        Select active
    --------------------- */
    // Commented out select2 - Not needed in React, using native select
    ...
    $(".modal").on("shown.bs.modal", function (e) {
        ...
        $(".slider-nav-thumbnails").each(function() {
            var $slider = $(this);
            if ($slider.hasClass('slick-initialized') && $slider.data('slick')) {
                $slider.slick("setPosition");
            }
